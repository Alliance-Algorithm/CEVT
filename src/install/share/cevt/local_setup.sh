...
: ${AMENT_CURRENT_PREFIX:="/workspaces/CEVT/src/install"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cevt/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cevt/environment/path.sh"
